...
class UpdateCalendarEventRequest extends FormRequest
{
    ...
    {
        return [
            'calendar_account_id' => 'sometimes|integer|exists:calendar_accounts,id',
            ...
            'visibility' => 'sometimes|in:default,public,private',
            ...
            'event_type' => 'sometimes|in:event,appointment,task',
        ];
    }
