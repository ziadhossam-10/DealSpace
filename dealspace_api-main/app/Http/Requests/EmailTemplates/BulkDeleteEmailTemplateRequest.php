...
class BulkDeleteEmailTemplateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'exception_ids.*' => 'integer|exists:email_templates,id',
            'ids' => 'sometimes|array',
            'ids.*' => 'integer|exists:email_templates,id',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'exception_ids.*.exists' => 'One or more exception email templates do not exist.',
            'ids.array' => 'The IDs must be an array.',
            'ids.*.integer' => 'Each ID must be an integer.',
            'ids.*.exists' => 'One or more email templates do not exist.',
        ];
    }
}
