...
import { useCreateUserMutation, useGetRolesQuery } from "./usersApi"
...
export default function CreateUser() {
  ...
  const [formData, setFormData] = useState<Omit<CreateUserRequest, "avatar"> & { confirmPassword: string }>({
    name: "",
    email: "",
    password: "",
    confirmPassword: "",
    ...
    <div className="bg-gray-50 min-h-screen p-6">
      <div className="container mx-auto">
        <div className="flex justify-between items-center">
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Add new user</h3>
          <button
